...
INPUT_INITIAL_BITSTREAM=${SOUNDGATES_REPO}hardware/design/reference/zynq_audio_adau1761/implementation/download.bit
...
#sshpass -p $LINUX_PASSWORD ssh $LINUX_USER@$ZEDBOARD_IP 'cd /root/reconos; ./reconos_init.sh'
