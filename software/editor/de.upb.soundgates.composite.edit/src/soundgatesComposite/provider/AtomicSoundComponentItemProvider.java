...
/**
 * This is the item provider adapter for a {@link soundgatesComposite.AtomicSoundComponent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AtomicSoundComponentItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SoundgatesCompositePackage.Literals.ATOMIC_SOUND_COMPONENT__TYPE,
				 false,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SoundgatesCompositePackage.Literals.ATOMIC_SOUND_COMPONENT__FLOAT_PROPERTIES);
			childrenFeatures.add(SoundgatesCompositePackage.Literals.ATOMIC_SOUND_COMPONENT__INTEGER_PROPERTIES);
			childrenFeatures.add(SoundgatesCompositePackage.Literals.ATOMIC_SOUND_COMPONENT__STRING_PROPERTIES);
			childrenFeatures.add(SoundgatesCompositePackage.Literals.ATOMIC_SOUND_COMPONENT__USER_STRING_PROPERTIES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SoundgatesCompositePackage.Literals.ATOMIC_SOUND_COMPONENT__FLOAT_PROPERTIES,
				 SoundgatesCompositeFactory.eINSTANCE.create(SoundgatesCompositePackage.Literals.ESTRING_TO_EFLOAT_OBJECT)));

		newChildDescriptors.add
			(createChildParameter
				(SoundgatesCompositePackage.Literals.ATOMIC_SOUND_COMPONENT__INTEGER_PROPERTIES,
				 SoundgatesCompositeFactory.eINSTANCE.create(SoundgatesCompositePackage.Literals.ESTRING_TO_EINTEGER_OBJECT)));

		newChildDescriptors.add
			(createChildParameter
				(SoundgatesCompositePackage.Literals.ATOMIC_SOUND_COMPONENT__STRING_PROPERTIES,
				 SoundgatesCompositeFactory.eINSTANCE.create(SoundgatesCompositePackage.Literals.ESTRING_TO_ESTRING)));

		newChildDescriptors.add
			(createChildParameter
				(SoundgatesCompositePackage.Literals.ATOMIC_SOUND_COMPONENT__USER_STRING_PROPERTIES,
				 SoundgatesCompositeFactory.eINSTANCE.create(SoundgatesCompositePackage.Literals.ESTRING_TO_ESTRING)));
	}
