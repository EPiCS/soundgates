 ...
 * @generated
 */
public class SoundgatesNavigatorActionProvider extends CommonActionProvider {
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof SoundgatesNavigatorItem) {
					selectedElement = ((SoundgatesNavigatorItem) selectedElement)
							.getView();
				...
				if (selectedElement instanceof Diagram) {
					...
					if (PatchEditPart.MODEL_ID
							.equals(SoundgatesVisualIDRegistry
									.getModelID(diagram))) {
						myDiagram = diagram;
					}
				}
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, SoundgatesDiagramEditor.ID);
