 ...
 * @generated
 */
public class AtomicSoundComponentNameEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public AtomicSoundComponentNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = SoundgatesParserProvider
					.getParser(
							SoundgatesElementTypes.AtomicSoundComponent_2001,
							getParserElement(),
							SoundgatesVisualIDRegistry
									.getType(soundgates.diagram.edit.parts.AtomicSoundComponentNameEditPart.VISUAL_ID));
		}
		return parser;
	}
