 ...
 * @generated
 */
public class AtomicSoundComponentName2EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public AtomicSoundComponentName2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new SoundgatesTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = SoundgatesParserProvider
					.getParser(
							SoundgatesElementTypes.AtomicSoundComponent_3002,
							getParserElement(),
							SoundgatesVisualIDRegistry
									.getType(soundgates.diagram.edit.parts.AtomicSoundComponentName2EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					SoundgatesEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
