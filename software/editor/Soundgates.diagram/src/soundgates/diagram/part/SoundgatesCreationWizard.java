 ...
 * @generated
 */
public class SoundgatesCreationWizard extends Wizard implements INewWizard {
	 ...
	 * @generated
	 */
	protected SoundgatesCreationWizardPage diagramModelFilePage;
	...
	public void init(IWorkbench workbench, IStructuredSelection selection) {
		...
		setWindowTitle(Messages.SoundgatesCreationWizardTitle);
		setDefaultPageImageDescriptor(SoundgatesDiagramEditorPlugin
				.getBundledImageDescriptor("icons/wizban/NewSoundgatesWizard.gif")); //$NON-NLS-1$
					...
					try {
						...
						ErrorDialog
								.openError(
										...
										Messages.SoundgatesCreationWizardOpenEditorError,
										null, e.getStatus());
					}
				}
			}
		...
		try {
			...
			if (e.getTargetException() instanceof CoreException) {
				ErrorDialog.openError(getContainer().getShell(),
						Messages.SoundgatesCreationWizardCreationError, null,
