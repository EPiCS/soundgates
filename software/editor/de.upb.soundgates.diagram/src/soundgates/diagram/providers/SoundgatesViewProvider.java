 ...
 * @generated
 */
public class SoundgatesViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return PatchEditPart.MODEL_ID.equals(op.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = SoundgatesVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = SoundgatesVisualIDRegistry.getVisualID(op
					.getSemanticHint());
			if (elementType != null) {
				if (!SoundgatesElementTypes.isKnownElementType(elementType)
				...
				if (domainElement != null
						&& visualID != SoundgatesVisualIDRegistry
								.getNodeVisualID(op.getContainerView(),
										domainElement)) {
					return false; // visual id for node EClass should match visual id from element type
				}
			} else {
				if (!PatchEditPart.MODEL_ID.equals(SoundgatesVisualIDRegistry
		...
		return AtomicSoundComponentEditPart.VISUAL_ID == visualID
				|| CompositeSoundComponentEditPart.VISUAL_ID == visualID
				|| PortEditPart.VISUAL_ID == visualID
				|| AtomicSoundComponent2EditPart.VISUAL_ID == visualID
				|| CompositeSoundComponent2EditPart.VISUAL_ID == visualID;
	}
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = SoundgatesVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != SoundgatesVisualIDRegistry
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(PatchEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			...
			visualID = SoundgatesVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case AtomicSoundComponentEditPart.VISUAL_ID:
			return createAtomicSoundComponent_2001(domainElement,
					containerView, index, persisted, preferencesHint);
		case CompositeSoundComponentEditPart.VISUAL_ID:
			return createCompositeSoundComponent_2002(domainElement,
					containerView, index, persisted, preferencesHint);
		case PortEditPart.VISUAL_ID:
			return createPort_3001(domainElement, containerView, index,
					persisted, preferencesHint);
		case AtomicSoundComponent2EditPart.VISUAL_ID:
			return createAtomicSoundComponent_3002(domainElement,
					containerView, index, persisted, preferencesHint);
		case CompositeSoundComponent2EditPart.VISUAL_ID:
			return createCompositeSoundComponent_3003(domainElement,
					containerView, index, persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (SoundgatesVisualIDRegistry.getVisualID(elementTypeHint)) {
	 ...
	 * @generated
	 */
	public Node createAtomicSoundComponent_2001(EObject domainElement,
		...
		node.setType(SoundgatesVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createCompositeSoundComponent_2002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
	...
	public Node createPort_3001(EObject domainElement, View containerView,
		...
		node.getStyles().add(NotationFactory.eINSTANCE.createFillStyle());
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(SoundgatesVisualIDRegistry.getType(PortEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		// initializeFromPreferences 
		final IPreferenceStore prefStore = (IPreferenceStore) preferencesHint
	 ...
	 * @generated
	 */
	public Node createAtomicSoundComponent_3002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
	 ...
	 * @generated
	 */
	public Node createCompositeSoundComponent_3003(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
	...
	public Edge createLink_4001(EObject domainElement, View containerView,
		...
		edge.setType(SoundgatesVisualIDRegistry.getType(LinkEditPart.VISUAL_ID));
	...
	public Edge createLink_4002(EObject domainElement, View containerView,
		...
		edge.setBendpoints(bendpoints);
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(SoundgatesVisualIDRegistry
	...
	private void stampShortcut(View containerView, Node target) {
		if (!PatchEditPart.MODEL_ID.equals(SoundgatesVisualIDRegistry
			...
			shortcutAnnotation.getDetails().put(
					"modelID", PatchEditPart.MODEL_ID); //$NON-NLS-1$
