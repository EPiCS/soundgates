 ...
 * <ul>
 *   <li>{@link soundgatesComposite.impl.CompositeSoundComponentImpl#getEmbeddedComponents <em>Embedded Components</em>}</li>
 *   <li>{@link soundgatesComposite.impl.CompositeSoundComponentImpl#getLinks <em>Links</em>}</li>
 *   <li>{@link soundgatesComposite.impl.CompositeSoundComponentImpl#getDelegations <em>Delegations</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CompositeSoundComponentImpl extends SoundComponentImpl implements CompositeSoundComponent {
	...
	protected EClass eStaticClass() {
		return SoundgatesCompositePackage.Literals.COMPOSITE_SOUND_COMPONENT;
	}
	...
	public EList<SoundComponent> getEmbeddedComponents() {
		if (embeddedComponents == null) {
			embeddedComponents = new EObjectContainmentWithInverseEList<SoundComponent>(SoundComponent.class, this, SoundgatesCompositePackage.COMPOSITE_SOUND_COMPONENT__EMBEDDED_COMPONENTS, SoundgatesCompositePackage.SOUND_COMPONENT__PARENT_COMPONENT);
		}
	...
	public EList<Link> getLinks() {
		if (links == null) {
			links = new EObjectContainmentEList<Link>(Link.class, this, SoundgatesCompositePackage.COMPOSITE_SOUND_COMPONENT__LINKS);
		}
		return links;
	}
	...
	public EList<Delegation> getDelegations() {
		if (delegations == null) {
			delegations = new EObjectContainmentEList<Delegation>(Delegation.class, this, SoundgatesCompositePackage.COMPOSITE_SOUND_COMPONENT__DELEGATIONS);
		}
		return delegations;
	}
