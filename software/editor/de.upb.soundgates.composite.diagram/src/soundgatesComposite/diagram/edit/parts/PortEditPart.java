...
import soundgatesComposite.diagram.edit.policies.PortItemSemanticEditPolicy;
import soundgatesComposite.diagram.edit.policies.SoundgatesConnectionHandleEditPolicy;
...
public class PortEditPart extends BorderedBorderItemEditPart {
	...
	public List<IElementType> getMARelTypesOnSource() {
		...
		types.add(soundgatesComposite.diagram.providers.SoundgatesCompositeElementTypes.Link_4003);
		types.add(soundgatesComposite.diagram.providers.SoundgatesCompositeElementTypes.Delegation_4004);
		return types;
	}
	...
	public List<IElementType> getMATypesForTarget(IElementType relationshipType) {
		LinkedList<IElementType> types = new LinkedList<IElementType>();
		if (relationshipType == soundgatesComposite.diagram.providers.SoundgatesCompositeElementTypes.Link_4003) {
			types.add(soundgatesComposite.diagram.providers.SoundgatesCompositeElementTypes.Port_3004);
		} else if (relationshipType == soundgatesComposite.diagram.providers.SoundgatesCompositeElementTypes.Delegation_4004) {
			types.add(soundgatesComposite.diagram.providers.SoundgatesCompositeElementTypes.Port_3004);
		}
		return types;
	}
