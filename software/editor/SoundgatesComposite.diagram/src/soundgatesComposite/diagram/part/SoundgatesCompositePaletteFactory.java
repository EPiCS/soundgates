 ...
 * @generated
 */
public class SoundgatesCompositePaletteFactory {
	...
	private ToolEntry createCompositeSoundComponent2CreationTool() {
		...
		types.add(SoundgatesCompositeElementTypes.CompositeSoundComponent_2002);
		...
		entry.setSmallIcon(SoundgatesCompositeElementTypes
				.getImageDescriptor(SoundgatesCompositeElementTypes.CompositeSoundComponent_2002));
	...
	private ToolEntry createLink1CreationTool() {
		ArrayList<IElementType> types = new ArrayList<IElementType>(2);
		types.add(SoundgatesCompositeElementTypes.Link_4003);
	...
	private ToolEntry createDelegation2CreationTool() {
		LinkToolEntry entry = new LinkToolEntry(
				...
				Collections
						.singletonList(SoundgatesCompositeElementTypes.Delegation_4004));
	...
	private ToolEntry createConcreteAtomicNodeCreationTool(String atomicType) {
		...
		ArrayList<IElementType> types = new ArrayList<IElementType>(2);
		types.add(SoundgatesCompositeElementTypes.AtomicSoundComponent_3005);
		...
		entry.setSmallIcon(SoundgatesCompositeElementTypes
				.getImageDescriptor(SoundgatesCompositeElementTypes.AtomicSoundComponent_3005));
	...
	private ToolEntry createConcreteCompositeNodeCreationTool(String name) {
		...
		ArrayList<IElementType> types = new ArrayList<IElementType>(2);
		types.add(SoundgatesCompositeElementTypes.CompositeSoundComponent_3006);
