...
import soundgatesComposite.diagram.edit.policies.CompositeSoundComponentCanonicalEditPolicy;
import soundgatesComposite.diagram.edit.policies.CompositeSoundComponentItemSemanticEditPolicy;
...
public class CompositeSoundComponentEditPart extends
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof soundgatesComposite.diagram.edit.parts.CompositeSoundComponentNameEditPart) {
			((soundgatesComposite.diagram.edit.parts.CompositeSoundComponentNameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureCompositeSoundComponentNameFigure());
			return true;
		}
		if (childEditPart instanceof soundgatesComposite.diagram.edit.parts.CompositeSoundComponentComponentCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureComponentCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((soundgatesComposite.diagram.edit.parts.CompositeSoundComponentComponentCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof soundgatesComposite.diagram.edit.parts.CompositeSoundComponentComponentCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureComponentCompartmentFigure();
			pane.remove(((soundgatesComposite.diagram.edit.parts.CompositeSoundComponentComponentCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		if (childEditPart instanceof soundgatesComposite.diagram.edit.parts.PortEditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(soundgatesComposite.diagram.part.SoundgatesCompositeVisualIDRegistry
