 ...
 * @generated
 */
public class CompositeSoundComponentName2EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public CompositeSoundComponentName2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new soundgatesComposite.diagram.edit.policies.SoundgatesCompositeTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = soundgatesComposite.diagram.providers.SoundgatesCompositeParserProvider
					.getParser(
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(
					this,
					null,
					soundgatesComposite.diagram.edit.parts.SoundgatesCompositeEditPartFactory
