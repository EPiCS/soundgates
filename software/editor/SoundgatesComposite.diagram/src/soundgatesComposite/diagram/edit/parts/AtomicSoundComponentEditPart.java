	...
	protected void createDefaultEditPolicies() {
		installEditPolicy(
				...
				new CreationEditPolicyWithCustomReparent(
						soundgatesComposite.diagram.part.SoundgatesCompositeVisualIDRegistry.TYPED_INSTANCE));
		super.createDefaultEditPolicies();
		installEditPolicy(
				EditPolicyRoles.SEMANTIC_ROLE,
				new soundgatesComposite.diagram.edit.policies.AtomicSoundComponentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE,
				new DragDropEditPolicy());
		installEditPolicy(
				EditPolicyRoles.CANONICAL_ROLE,
				new soundgatesComposite.diagram.edit.policies.AtomicSoundComponentCanonicalEditPolicy());
