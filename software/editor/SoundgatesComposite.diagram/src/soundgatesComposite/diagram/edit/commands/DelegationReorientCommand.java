...
public class DelegationReorientCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof soundgatesComposite.Delegation) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return soundgatesComposite.diagram.edit.policies.SoundgatesCompositeBaseItemSemanticEditPolicy
				.getLinkConstraints().canExistDelegation_4004(container,
	 ...
	 * @generated
	 */
	protected soundgatesComposite.Delegation getLink() {
		return (soundgatesComposite.Delegation) getElementToEdit();
	}
