 ...
 * @generated
 */
public class CompositeSoundComponentCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public CompositeSoundComponentCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (name != null) {
			...
			newElement = SoundgatesCompositeFactory.eINSTANCE
		...
		Workbench owner = (Workbench) getElementToEdit();
		owner.getCompositeSoundComponents().add(newElement);
	...
	protected void doConfigure(
			soundgatesComposite.CompositeSoundComponent newElement,
