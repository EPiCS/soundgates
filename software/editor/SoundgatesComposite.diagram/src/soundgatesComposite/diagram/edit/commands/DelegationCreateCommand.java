...
import soundgatesComposite.diagram.edit.policies.SoundgatesCompositeBaseItemSemanticEditPolicy;
...
public class DelegationCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	private final soundgatesComposite.CompositeSoundComponent container;
	...
	public boolean canExecute() {
		...
		return SoundgatesCompositeBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateDelegation_4004(getContainer(), getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		Delegation newElement = SoundgatesCompositeFactory.eINSTANCE.createDelegation();
	 ...
	 * @generated
	 */
	protected void doConfigure(soundgatesComposite.Delegation newElement,
	 ...
	 * @generated
	 */
	protected soundgatesComposite.Port getSource() {
		return (soundgatesComposite.Port) source;
	}

	/**
	 * @generated
	 */
	protected soundgatesComposite.Port getTarget() {
		return (soundgatesComposite.Port) target;
	}

	/**
	 * @generated
	 */
	public soundgatesComposite.CompositeSoundComponent getContainer() {
		return container;
	}
	 ...
	 * @generated
	 */
	private static soundgatesComposite.CompositeSoundComponent deduceContainer(
			EObject source, EObject target) {
		...
		for (EObject element = source; element != null; element = element
			...
			if (element instanceof soundgatesComposite.CompositeSoundComponent) {
				return (soundgatesComposite.CompositeSoundComponent) element;
			}
		}
		return null;
	}
