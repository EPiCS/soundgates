package soundgatesComposite.diagram.messageDialogs;
...
public class MessageDialogs {
	...
	public static void portsMustHaveUniqueNames() {		
		MessageDialog.openWarning(null, "Ports of a sound compnent must have unique names", "Please assign each port an unique name");		
	}
