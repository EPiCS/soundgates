 ...
 * @generated
 */
public class SoundgatesCompositeDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public SoundgatesCompositeDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof soundgatesComposite.diagram.navigator.SoundgatesCompositeDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((soundgatesComposite.diagram.navigator.SoundgatesCompositeDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new soundgatesComposite.diagram.navigator.SoundgatesCompositeDomainNavigatorItem(
