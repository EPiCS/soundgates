 ...
 * @generated
 */
public class SoundgatesDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public SoundgatesDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof SoundgatesDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((SoundgatesDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new SoundgatesDomainNavigatorItem(
