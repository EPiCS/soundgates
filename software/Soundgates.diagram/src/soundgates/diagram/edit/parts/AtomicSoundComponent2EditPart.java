...
import soundgates.diagram.edit.policies.AtomicSoundComponent2CanonicalEditPolicy;
import soundgates.diagram.edit.policies.AtomicSoundComponent2ItemSemanticEditPolicy;
...
public class AtomicSoundComponent2EditPart extends
	 ...
	 * @generated
	 */
	public AtomicSoundComponent2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new AtomicSoundComponent2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AtomicSoundComponentName2EditPart) {
			((AtomicSoundComponentName2EditPart) childEditPart)
