 ...
 * @generated
 */
public class SoundgatesInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new SoundgatesNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				PatchEditPart.MODEL_ID));
		SoundgatesDiagramEditorUtil.runWizard(getShell(), wizard,
