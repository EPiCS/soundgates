...
(function() {
  var expand, expandComponent, generateTestdata, getComponentList, getExecution, getExecutionList, getFormattedTime, getLastExecution, initComponentNavigation, initExecutionNavigation, initializeButtons, initializeDocument, isInt, print, readyFn, removeEveryExecution, removeExecution, __calcAverageExecutionTime, __calcAverageExecutionTimeList, __createDiagram, __getJsDate, __prepareSamples, __replaceRaute;
  ...
  initComponentNavigation = function(components) {
    ...
    for (_i = 0, _len = components.length; _i < _len; _i++) {
      c = components[_i];
      li = $('<li>').appendTo(nav);
      _results.push($('<a href="#">').appendTo(li).text(c.uid).fadeIn());
    }
    return _results;
  };
