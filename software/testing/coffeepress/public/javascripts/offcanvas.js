...
(function() {
  var expand, expandComponent, getExecution, getExecutionDeprecated, getFormattedTime, getLastExecution, getLastExecutionDeprecated, isInt, print, readyFn, __createDiagram, __getJsDate, __replaceRaute;
  ...
  __createDiagram = function(component) {
    ...
    d3.select(selector).append('svg').datum(component.samples).call(chart);
    return chart.update();
  };
