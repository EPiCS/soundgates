...
(function() {
  var expand, expandComponent, generateTestdata, getComponentList, getExecution, getExecutionList, getFormattedTime, getLastExecution, initComponentNavigation, initExecutionNavigation, initializeButtons, initializeDocument, isInt, print, readyFn, removeEveryExecution, removeExecution, __addSampleInformation, __calcAverageExecutionTime, __calcAverageExecutionTimeList, __calcTypeImplementationDistribution, __createBrush, __createDiagram, __getJsDate, __prepareSamples, __replaceRaute;
  ...
  __createBrush = function(component) {
    var area, brush, brushed, context, draw_data, e, height, i, length, selector, svg, values, width, xAxis, x_domain, x_scale, y_domain, y_scale;
    selector = __replaceRaute(component.uid);
    ...
    brush = d3.svg.brush().x(x_scale).on("brush", brushed);
