...
(function() {
  var expand, expandComponent, generateTestdata, getExecution, getFormattedTime, getLastExecution, initializeDocument, isInt, print, readyFn, removeEveryExecution, removeExecution, __calcAverageExecutionTime, __createDiagram, __getJsDate, __prepareSamples, __replaceRaute;
  ...
  initializeDocument = function() {
    $("#list-group").children(".list-group-item").each((function(_this) {
