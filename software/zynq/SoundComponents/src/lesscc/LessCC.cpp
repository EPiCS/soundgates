...
DEFINE_COMPONENTNAME(LessCC, "lesscc")
...
EXPORT_SOUNDCOMPONENT_SW_ONLY(LessCC);

LessCC::LessCC(std::vector<std::string> params) :
		SoundComponentImpl(params)
{
	...
	CREATE_AND_REGISTER_PORT3(LessCC, In, ControlPort, In0, 1);
	CREATE_AND_REGISTER_PORT3(LessCC, In, ControlPort, In1, 2);

	CREATE_AND_REGISTER_PORT3(LessCC, Out, ControlPort, Out, 1);
}
