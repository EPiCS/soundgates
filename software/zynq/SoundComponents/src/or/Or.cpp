...
EXPORT_SOUNDCOMPONENT_SW_ONLY(Or);

Or::Or(std::vector<std::string> params) :
		SoundComponentImpl(params)
{
	...
	CREATE_AND_REGISTER_PORT3(Or, In, ControlPort, In0, 1);
	CREATE_AND_REGISTER_PORT3(Or, In, ControlPort, In1, 2);

	CREATE_AND_REGISTER_PORT3(Or, Out, ControlPort, Out, 1);
}
