...
public:
    ...
    DECLARE_PORT2(ControlPort, BiasIn, 11);
    DECLARE_PORT2(ControlPort, BiasIn, 12);
    DECLARE_PORT2(ControlPort, BiasIn, 13);
    DECLARE_PORT2(ControlPort, BiasIn, 14);
    DECLARE_PORT2(ControlPort, BiasIn, 15);
    DECLARE_PORT2(ControlPort, BiasIn, 16);
    DECLARE_PORT2(ControlPort, BiasIn, 17);
    DECLARE_PORT2(ControlPort, BiasIn, 18);
    DECLARE_PORT2(ControlPort, BiasIn, 19);
    DECLARE_PORT2(ControlPort, BiasIn, 20);
