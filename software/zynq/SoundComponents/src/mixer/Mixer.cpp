...
Mixer::Mixer(std::vector<std::string> params) : SoundComponentImpl(params) {
    ...
    CREATE_AND_REGISTER_PORT2(Mixer, In, ControlPort, BiasIn, 11);
    CREATE_AND_REGISTER_PORT2(Mixer, In, ControlPort, BiasIn, 12);
    CREATE_AND_REGISTER_PORT2(Mixer, In, ControlPort, BiasIn, 13);
    CREATE_AND_REGISTER_PORT2(Mixer, In, ControlPort, BiasIn, 14);
    CREATE_AND_REGISTER_PORT2(Mixer, In, ControlPort, BiasIn, 15);
    CREATE_AND_REGISTER_PORT2(Mixer, In, ControlPort, BiasIn, 16);
    CREATE_AND_REGISTER_PORT2(Mixer, In, ControlPort, BiasIn, 17);
    CREATE_AND_REGISTER_PORT2(Mixer, In, ControlPort, BiasIn, 18);
    CREATE_AND_REGISTER_PORT2(Mixer, In, ControlPort, BiasIn, 19);
    CREATE_AND_REGISTER_PORT2(Mixer, In, ControlPort, BiasIn, 20);
