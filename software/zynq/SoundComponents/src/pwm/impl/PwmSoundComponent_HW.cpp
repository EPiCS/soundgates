...
#include "PwmSoundComponent_HW.hpp"
...
PwmSoundComponent_HW::PwmSoundComponent_HW(std::vector<std::string> params) : PwmSoundComponent(params), m_HWTSlot(PwmSoundComponent::name) {

}

void PwmSoundComponent_HW::init(){
