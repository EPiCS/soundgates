...
#ifndef GREATERCC_HPP_
#define GREATERCC_HPP_
...
class GreaterCC: public SoundComponentImpl
{
...
public:
	...
	GreaterCC(std::vector<std::string> params);
	virtual ~GreaterCC();
...
private:
    GreaterCC& m_ObjRef;
public:
    OnChangeIn0(GreaterCC& ref ) : m_ObjRef(ref){ }
...
private:
    GreaterCC& m_ObjRef;
public:
    OnChangeIn1(GreaterCC& ref) : m_ObjRef(ref){ }
