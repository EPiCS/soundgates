...
void Patch::createSoundComponent(int uid, std::string type, std::string parameters){
...
void Patch::createSoundComponent(int uid, std::string type, int slot, std::string parameters){
