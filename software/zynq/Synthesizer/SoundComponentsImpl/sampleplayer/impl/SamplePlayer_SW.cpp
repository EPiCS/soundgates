...
//                break;
    ...
    char* writeLeftPortPtr  = ((BufferedLink*) m_SoundOut_LeftPort->getLink())->getWriteBuffer();
    char* writeRightPortPtr = ((BufferedLink*) m_SoundOut_RightPort->getLink())->getWriteBuffer();
...
void SamplePlayer_SW::process() {
    ...
    int* writeLeftPortPtr  = (int*)((BufferedLink*)m_SoundOut_LeftPort->getLink())->getWriteBuffer();
    int* writeRightPortPtr = (int*)((BufferedLink*)m_SoundOut_RightPort->getLink())->getWriteBuffer();
