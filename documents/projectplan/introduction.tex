...
Finally Chapters \ref{chapter:Organization} and \ref{chapter:Workplan} describe how the group will organize itself and the groups' milestones.
	...
	\todo{Hier könnte man noch etwas weiter ausholen finde ich (Gunnar)}
	...
	\section{Introduction to sound synthesis}
		...
		\caption{Easiest way to generate sound on a digital system \todo{Weissen Rand um die Zeichnung entfernen}}
		...
		\subsection{Further transformation}
			...
			\subsubsection{Envelope modulation}
				...
				This pattern can be used for many instruments, especially pianos exhibit a default \ac{ADSR} pattern. An exemplary \acute{ADSR} pattern is shown in figure \ref{fig:adsr}
